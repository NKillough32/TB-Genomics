...
-- These tables hold contact, exposure, and location-event evidence separately
-- from genomic case records so epidemiological corroboration can be queried
-- and audited instead of being kept only in free-text investigation notes.
