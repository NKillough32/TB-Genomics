...
| Epidemiology linkage workflows | Structured tables and APIs for contacts, exposures, locations, case-location events, and case-contact links. | Tables and read/create API routes are available. Workflow UI for direct entry remains a follow-on item. |
